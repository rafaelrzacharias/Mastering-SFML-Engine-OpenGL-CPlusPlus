...
void S_SheetAnimation::Update(float l_dT) {
	...
	for(auto &entity : m_entities) {
		auto sheet = entities->GetComponent<C_SpriteSheet>(entity, Component::SpriteSheet);
...
{
	auto sheet = m_systemManager->GetEntityManager()->GetComponent<C_SpriteSheet>(l_entity,Component::SpriteSheet);
